...
//   const DailyDevotionView({super.key});
//
//   @override
...
//     with TableFocusNodeMixin<DailyDevotionView, DevotionMd> {
//   @override
...
//             ElevatedButton(
//                 onPressed: () {
//                   onEdit((p0) => CreateDailyDevotionPopup(model: p0), null);
//                 },
...
//               onEdit: () {
//                 onEdit((p0) => CreateDailyDevotionPopup(model: p0),
...
//     final success = await dependencyManager.firestore.getDevotions();
//     if (success.isLeft) {
//       return success.left;
//     } else {
